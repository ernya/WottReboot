...
/*template<>
VertexBufferData<char>::VertexBufferData(int components, int size);

template<>
VertexBufferData<unsigned char>::VertexBufferData(int components, int size);

template<>
VertexBufferData<short>::VertexBufferData(int components, int size);

template<>
VertexBufferData<unsigned short>::VertexBufferData(int components, int size);

template<>
VertexBufferData<int>::VertexBufferData(int components, int size);

template<>
VertexBufferData<unsigned int>::VertexBufferData(int components, int size);

template<>
VertexBufferData<float>::VertexBufferData(int components, int size);

template<>
VertexBufferData<double>::VertexBufferData(int components, int size);*/
